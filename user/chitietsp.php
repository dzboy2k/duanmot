<body>
    <div class="detail-product-main mt-5">

        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="product-img w-100">
                        <img class="w-100" src="/img/DBC0014BRW.WR20A-hover.jpg" alt="">
                    </div>
                ...
                <div class="col-lg-7">
                    <div class="product-info">
                        ...
                        <div class="pro-text  mt-4">
                            * Giá sản phẩm thay đổi tùy theo trọng lượng thực tế của sản phẩm. Vui lòng gọi
                            1900636526 để được hỗ trợ
                        </div>
                        <div class="product-size d-flex mt-4">
