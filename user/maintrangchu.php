    ...
    <div class="container">
      ...
      <div class="product">
        <div class="row">
          ...
          <div class="col-md-3 col-sm-4 col-6 mt-5">
            <div class="card">
              <img src="/img/VMP1047AMW-RG06A-hover.jpg" class="card-img-top" alt="..." />
              <div class="card-body">
                <h5 class="card-title">Card title</h5>
    ...
    <section class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-2 user">
          <img src="/img/Luxury_1.jpg" alt="" />
        </div>
        <div class="col-md-2 user">
          <img src="/img/Luxury_3.jpg" alt="" />
        </div>
        <div class="col-md-2 user">
          <img src="/img/Luxury_4.jpg" alt="" />
        </div>
        <div class="col-md-2 user">
          <img src="/img/Luxury_5.jpg" alt="" />
        </div>
        <div class="col-md-2 user">
          <img src="/img/Luxury_1.jpg" alt="" />
        </div>
    ...
    <div class="container">
      ...
      <div class="khachhang text-center">
        ...
        <div class="row">
          ...
          <div class="icon">
            <i class="ti-star"></i><i class="ti-star"></i><i class="ti-star"></i><i class="ti-star"></i><i
              class="ti-star"></i>
          </div>
          <p>MR DIEM</p>
        </div>
