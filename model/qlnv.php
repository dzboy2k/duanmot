...
function modalnv($hoten,$tendangnhap,$ngaysinh,$target_file,$email,$sdt,$diachi,$vaitro,$luong,$id_ceo,$id_nv){
   $sql = "UPDATE nhanvien SET hoten='$hoten',tendangnhap='$tendangnhap',ngaysinh='$ngaysinh',hinh_anhnv='$target_file',email='$email',
   sdt='$sdt',diachi='$diachi',vaitro='$vaitro',luong=$luong,id_ceo=$id_ceo 
   WHERE id_nv = $id_nv
   ";
   pdo_execute($sql);
}
